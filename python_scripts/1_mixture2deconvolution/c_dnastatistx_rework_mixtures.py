...
from pipeline_config import (
    ANALYSIS_MIXTURES_DIR as MIXTURES_DIR,
    COND_KNOWNS,
    DNAX_CONFIG_YAML,
    DNAX_REWORK_OUTPUT_ROOT as OUTPUT_ROOT,
    REFERENCE_FILE,
    RESOURCES_PATH,
)
...
def dnax_three_lab_mixtures_combined(
    ...
    DELETE_INTERMEDIATE_FILES = False #cfg['DELETE_INTERMEDIATE_FILES']
