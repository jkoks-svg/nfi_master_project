...
from pipeline_config import (
    DONOR_DIR,
    DROPIN_OUTPUT_LOG_DIR as OUT_LOG_DIR,
    DROPIN_OUTPUT_MIXTURES_DIR as OUT_MIXTURE_DIR,
    RAW_MIXTURE_DIR as MIXTURE_DIR,
)
...
REPLICATES = [1, 2, 3]
N_CONTRIBUTORS_LIST = [2]  # [2, 3, 4, 5] for full 2p-5p dataset
