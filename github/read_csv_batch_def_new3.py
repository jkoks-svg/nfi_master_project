...
RUN_MODE = "single"  # "batch" or "single"
if RUN_MODE == "batch":
...
OUT_ROOT = BASE/'inputs'/'input_2p_Bayes'/'output_single_MLE'
...
RAW_MIX_DIR = r"C:\Users\jortk\OneDrive\OneDrive Documenten\Thesis\Code_new\inputs\input_2p_Bayes"
    ...
    for info in best["infos"]:
        ...
        for mode in modes_to_run:
            ...
            if SHOW_MIXTURE_HISTOGRAMS:
                ...
                ax = plt.gca()
                ax.hist(totals_on, bins=60, edgecolor="black", alpha=0.35, label="Sampled donors")
