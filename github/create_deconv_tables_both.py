...
from gamma_model_degr_on import log_likelihood_locus
...
from mcmc_parameters_degr_on import (
...
def main():
    script_path = Path(
        r"C:\Users\jortk\OneDrive\OneDrive Documenten\Thesis\Code_new"
    )
    resources_path = script_path / "resources"
    config_yaml = resources_path / "config_2p_Bayes_test.yaml"
    
    mixture_folder = Path(r"C:\Users\jortk\Documents\inputs\input_2p_Bayes\mixtures_2p")
    #mixtures = [p.stem for p in mixture_folder.glob("*.txt")]
    mixtures = ["1_1B2", "2_2B2", "3_2B2"]
    
    single_mixture_folder = mixture_folder
    rework_mixture_folder = mixture_folder
    
    single_output_folder = r"C:\Users\jortk\Documents\inputs\input_2p_Bayes\output_single_MCMC_1B2_test"
    rework_output_folder = None #r"C:\Users\jortk\Documents\inputs\input_2p_Bayes\output_rework_MLE_1B2_v9"
    ...
    run_rework_analysis = False

    use_candidate_pairs_single = False
    ...
    # Paths
    # --------------------------------------------------
    single_params_json = lambda mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_singles_frac_thresh_on_degr_{degr_mode}\mixtures\{mixture}\results.json"
    )

    combined_params_json = lambda rework_mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_rework_frac_thresh_on_degr_{degr_mode}\mixtures\{rework_mixture}\results.json"
    )

    reference_csv = lambda mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_singles_frac_thresh_on_degr_{degr_mode}\mixtures\{mixture}\results_joint_deconvolution_H2.csv"
    )

    combined_reference_csv = lambda rework_mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_rework_frac_thresh_on_degr_{degr_mode}\mixtures\{rework_mixture}\results_joint_deconvolution_H2.csv"
    )

    single_candidate_csv = lambda mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_singles_frac_thresh_on_degr_{degr_mode}\mixtures\{mixture}\results_joint_deconvolution_H2_clean.csv"
    )

    rework_candidate_csv = lambda rework_mixture: Path(
        rf"C:\Users\jortk\Documents\inputs\input_HT_2p_nodropin\output_DNASx_rework_frac_thresh_on_degr_{degr_mode}\mixtures\{rework_mixture}\results_joint_deconvolution_H2_clean.csv"
    )
