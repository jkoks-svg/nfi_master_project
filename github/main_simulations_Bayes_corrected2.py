...
from sample_from_joint_corrected2 import run_joint_sampling
from dnax_pipeline_generate_corrected2 import generate_mixtures
...
from read_csv_traces_corrected2 import compare_with_lab_combined_profiles
...
if N_CONTRIBUTORS_RUN == 2:
    ...
    OUTPUT_ROOT = Path(r"C:\Users\jortk\Documents\inputs\input_2p_Bayes\output_single_MCMC_2p_corrected_v2")   
    ...
    traces_folder_root =  Path( r"C:\Users\jortk\Documents\inputs\input_2p_Bayes\output_rework_MCMC_2p_corrected_v2") 
